...
def thread_jobdxsyewei():
    while True:
        ...
        if len_return_data:
            ...
            #     continue
            global datadxsyewei
            datadxsyewei = ('4', feedback_data_location)
...
def thread_jobdxstemp():
    while True:
        ...
        if len_return_data:
            ...
            #     continue
            global datadxstemp
            datadxstemp = ('4', feedback_data_temp)
        return datadxstemp
        break
...
def thread_jobtrtemp():
    ...
    while True:
        ...
        if len_return_data:
            ...
            #     continue
            global datatrtemp
            datatrtemp = ('4', feedback_data_temp)
        return datatrtemp
        break
